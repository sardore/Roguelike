...
export const ORIGINS:OriginDefinition[]=[
  {
    ...
    hp:34,attack:5,defense:1,gold:22,ammo:5,mana:8,spells:['clear-sight'],
  ...
  },
  {
    ...
    hp:40,attack:5,defense:2,gold:15,ammo:0,mana:5,spells:['stone-ward'],
  ...
  },
  {
    ...
    hp:29,attack:4,defense:1,gold:18,ammo:15,mana:6,spells:['blink'],
  ...
  },
  {
    ...
    hp:35,attack:5,defense:1,gold:34,ammo:8,mana:6,spells:['force-pulse'],
  ...
  },
  {
    ...
    hp:32,attack:4,defense:2,gold:8,ammo:2,mana:11,spells:['ember-dart','sanctuary'],
