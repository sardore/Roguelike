...
const VAULTS:VaultDefinition[]=[
  {id:'broken-gate',family:'fort',weight:8,minDepth:1,tags:['humanoid','construct'],rotate:true,reflect:true,rows:['  ##+##  ','###...###','+..P.P..+','###...###','  ##+##  ']},
  {id:'split-watch',family:'fort',weight:6,minDepth:4,tags:['humanoid','royal','construct'],rotate:true,reflect:true,rows:['###+###','#.....#','+.###.+','#..P..#','###.###']},
  {id:'barricade-ring',family:'fort',weight:5,minDepth:7,tags:['humanoid','royal'],rotate:true,reflect:true,rows:['###+###','#.....#','#.###.#','+.#P#.+','#.###.#','#.....#','###+###']},
  {id:'guarded-junction',family:'fort',weight:5,minDepth:10,tags:['humanoid','construct','royal'],rotate:true,reflect:true,rows:['  +.+  ','###.###','...P...','###.###','  +.+  ']},

  {id:'flooded-crossing',family:'water',weight:8,minDepth:1,tags:['aquatic','venom'],rotate:true,reflect:true,rows:['~~~=~~~','~~.=.~~','...=...','~~.=.~~','~~~=~~~']},
  {id:'reed-islets',family:'water',weight:6,minDepth:5,tags:['aquatic','venom','plant'],rotate:true,reflect:true,rows:[' ~~.~~ ','~gg.gg~','.g...g.','~gg.gg~',' ~~.~~ ']},
  {id:'sunken-aisle',family:'water',weight:5,minDepth:8,tags:['aquatic','undead'],rotate:true,reflect:true,rows:['~~~.~~~','~P...P~','...=...','~P...P~','~~~.~~~']},
  {id:'delta-shrine',family:'water',weight:4,minDepth:12,tags:['aquatic','spirit','royal'],rotate:true,reflect:true,rows:['~~...~~','~._._.~','..===..','~._._.~','~~...~~']},

  {id:'ossuary-gate',family:'crypt',weight:8,minDepth:4,tags:['undead','spirit'],rotate:true,reflect:true,rows:['###+###','#b.b.b#','+.P.P.+','#b.b.b#','###.###']},
  {id:'bone-cells',family:'crypt',weight:5,minDepth:10,tags:['undead','spirit'],rotate:true,reflect:true,rows:['###+###','#b#.#b#','+.#.#.+','#b#.#b#','###+###']},
  {id:'grave-cross',family:'crypt',weight:5,minDepth:8,tags:['undead','spirit'],rotate:true,reflect:true,rows:[' b#.#b ','###.###','...P...','###.###',' b#.#b ']},
  {id:'bone-rotunda',family:'crypt',weight:4,minDepth:15,tags:['undead','spirit','royal'],rotate:true,reflect:true,rows:[' b###b ','b#...#b','#.P.P.#','+..b..+','#.P.P.#','b#...#b',' b###b ']},

  {id:'fungal-pocket',family:'wild',weight:8,minDepth:3,tags:['fungal','plant','beast'],rotate:true,reflect:true,rows:[' TgggT ','TgmmmgT','gmm.mmg','TgmmmgT',' TgggT ']},
  {id:'woodland-fork',family:'wild',weight:7,minDepth:1,tags:['plant','beast','fungal'],rotate:true,reflect:true,rows:['TT...TT','Tg...gT','..TTT..','Tg...gT','TT...TT']},
  {id:'thorn-alcove',family:'wild',weight:5,minDepth:8,tags:['plant','venom','beast'],rotate:true,reflect:true,rows:['TTT.TTT','Tg...gT','T..m..T','Tg...gT','TTT.TTT']},
  {id:'moss-ruin',family:'wild',weight:5,minDepth:10,tags:['plant','fungal','humanoid'],rotate:true,reflect:true,rows:['##:+:##','#g...g#','+.T.T.+','#g...g#','##:+:##']},

  {id:'crystal-prism',family:'arcane',weight:7,minDepth:8,tags:['crystal','ice','caster'],rotate:true,reflect:true,rows:[' cc.cc ','c.i.i.c','.i...i.','c.i.i.c',' cc.cc ']},
  {id:'shrine-walk',family:'arcane',weight:6,minDepth:7,tags:['spirit','caster','royal'],rotate:true,reflect:true,rows:['P.._..P','.##.##.','_.._.._','.##.##.','P.._..P']},
  {id:'rune-court',family:'arcane',weight:5,minDepth:12,tags:['caster','spirit','crystal'],rotate:true,reflect:true,rows:['P#...#P','.#._.#.','..P.P..','.#._.#.','P#...#P']},
  {id:'frozen-aisle',family:'arcane',weight:5,minDepth:12,tags:['ice','crystal','caster'],rotate:true,reflect:true,rows:['cii.iic','i.....i','..ccc..','i.....i','cii.iic']},

  {id:'forge-yard',family:'works',weight:7,minDepth:6,tags:['construct','fire'],rotate:true,reflect:true,rows:['###+###','#o...o#','+.=~=.+','#o...o#','###.###']},
  {id:'collapsed-workshop',family:'works',weight:5,minDepth:12,tags:['construct','fire','humanoid'],rotate:true,reflect:true,rows:['##:+:##','#::..:#','+.P.P.+','#:..::#','##:+:##']},
  {id:'slag-channel',family:'works',weight:5,minDepth:10,tags:['construct','fire'],rotate:true,reflect:true,rows:['oo...oo','o.=~=.o','..===..','o.=~=.o','oo...oo']},
  {id:'gear-court',family:'works',weight:4,minDepth:16,tags:['construct','humanoid'],rotate:true,reflect:true,rows:['P##+##P','#.....#','+.P.P.+','#.....#','P##+##P']},

  {id:'void-lens',family:'rift',weight:7,minDepth:16,tags:['void','aberrant'],rotate:true,reflect:true,rows:['  v.v  ',' v...v ','v..P..v',' v...v ','  v.v  ']},
  {id:'broken-ring',family:'rift',weight:5,minDepth:20,tags:['void','aberrant','spirit'],rotate:true,reflect:true,rows:['vv...vv','v.###.v','.#...#.','v.###.v','vv...vv']},
  {id:'rift-bridge',family:'rift',weight:5,minDepth:22,tags:['void','aberrant'],rotate:true,reflect:true,rows:['vvv=vvv','vv.=.vv','...=...','vv.=.vv','vvv=vvv']},
  {id:'fractured-sanctum',family:'rift',weight:4,minDepth:26,tags:['void','aberrant','spirit'],rotate:true,reflect:true,rows:['v##+##v','#v...v#','+.P_P.+','#v...v#','v##+##v']},
];
...
function stamp(floor:FloorMap,rows:string[],left:number,top:number,reserved:Set<string>):void{for(let y=0;y<rows.length;y+=1)for(let x=0;x<rows[y]!.length;x+=1){const ch=rows[y]![x]!,kind=LEGEND[ch];if(!kind)continue;const wx=left+x,wy=top+y;if(!inBounds(floor,wx,wy)||reserved.has(`${wx},${wy}`))continue;floor.tiles[idx(floor,wx,wy)]=terrainTile(kind);}}
...
function placeOne(floor:FloorMap,def:VaultDefinition,rng:DeterministicRng,reserved:Set<string>,stamps:VaultStamp[]):boolean{const rows=transformed(def,rng),placements=candidatePlacements(floor,rows,rng,reserved).filter((candidate)=>stamps.every((stamp)=>manhattan(stamp.center,candidate.center)>=8)),chosen=placements[0];if(!chosen)return false;stamp(floor,rows,chosen.left,chosen.top,reserved);stamps.push({id:def.id,family:def.family,center:chosen.center});return true;}
